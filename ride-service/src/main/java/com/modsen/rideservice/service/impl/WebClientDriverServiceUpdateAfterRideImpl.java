...
@Service
@AllArgsConstructor
public class WebClientDriverServiceUpdateAfterRideImpl implements WebClientService<Void> {

  private final WebClient webClient;

  @Override
  public ResponseEntity<Void> getResponseEntity(String driverUpdateUrl, Object body) {
    return webClient
        .put()
        .uri(driverUpdateUrl)
        .retrieve()
